...
export default function PlanningModern() {
  ...
  const { data: services } = useQuery({
    queryKey: ['planning-services', userSalon?.id],
    queryFn: async () => {
      // Utiliser directement les données du salon connecté
  ...
  // Debug: Vérifier les données du salon
  console.log('📊 Planning: userSalon:', userSalon);
  console.log('👥 Planning: team_members:', userSalon?.team_members);
                          ...
                          <FormControl>
                            <Select onValueChange={(value) => setSelectedStaffId(value)}>
                              ...
                              <SelectContent className="max-h-60 z-50">
                                <SelectItem value="1759862715734">afrt</SelectItem>
                                <SelectItem value="1759862720573">biugo</SelectItem>
                              </SelectContent>
                            </Select>
                          </FormControl>
                        </FormItem>
