...
async function loadSalonsFromDatabase() {
  try {
    ...
    // Salon Avyento uniquement (modèle officiel)
    const demoSalons = [
      {
        id: "salon-avyento",
        name: "Salon Avyento",
        slug: "salon-avyento",
        description: "Salon de beauté moderne spécialisé dans les services premium",
        address: "Paris 1er, France",
        phone: "01 42 96 00 00",
        email: "contact@avyento.fr",
        rating: 4.8,
        reviews: ["Service exceptionnel", "Très professionnel"],
        reviewsCount: 127,
        image: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=500&h=800&fit=crop&q=80",
        photos: ["https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=500&h=800&fit=crop&q=80"],
        ...
        shareableUrl: "/salon",
        route: "/salon",
        customColors: { primary: "#8B5CF6", accent: "#7C3AED", intensity: 70 },
        distance: "0.5 km",
        location: "Paris 1er"
      }
    ];
...
export async function registerFullStackRoutes(app: Express): Promise<Server> {
  ...
  // Seul le salon Avyento officiel est maintenant disponible via loadSalonsFromDatabase()
  
  // Charger les salons de démonstration au démarrage
