    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col h-[calc(100vh-80px)]">
              ...
              <div className="flex flex-col items-center justify-center h-full px-4">
                <div className="text-center">
                  <div className="mb-8">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-900 mb-2">Comment puis-je vous aider aujourd'hui ?</h2>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto">
                    {[
                      ...
                      { text: "Explique-moi l'IA", icon: "🤖" }
                    ].map((suggestion, idx) => (
                      <button
                        key={idx}
                        onClick={() => handleSuggestionClick(suggestion.text)}
                        className="flex items-center gap-3 p-4 text-left border border-gray-200 hover:border-gray-300 rounded-xl hover:bg-gray-50 transition-colors"
                      >
              ...
              <div className="space-y-6 px-4 py-6">
                {chatHistory.map((msg, idx) => (
                  <div key={idx} className="group">
                    <div className={`flex gap-4 ${msg.role === 'user' ? 'ml-12' : ''}`}>
                      {msg.role === 'assistant' && (
          ...
          {/* Zone de saisie ChatGPT */}
          <div className="border-t border-gray-200 bg-white p-4">
            <div className="max-w-3xl mx-auto">
              <form onSubmit={handleChatSubmit} className="relative">
                <div className="flex items-end gap-2 bg-gray-100 rounded-3xl p-3">
