...
import { Search, MapPin, Star, ArrowLeft, Palette, Sparkles, Hand, Crown } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { useLocation } from "wouter";

export default function ManucureService() {
  const [, setLocation] = useLocation();
  const [searchLocation, setSearchLocation] = useState("");

  const manucureServices = [
    {
      id: 1,
    ...
    {
      id: 2,
      name: "Pose Gel/Vernis Semi-permanent",
      description: "Tenue jusqu'à 3 semaines, finition parfaite",
      price: "45-65€",
      duration: "1h",
    ...
    },
    {
      id: 3,
      name: "Nail Art",
      description: "Décoration artistique personnalisée",
      price: "50-80€",
      duration: "1h-1h30",
    ...
    },
    {
      ...
      description: "Allongement et renforcement des ongles",
      price: "60-90€",
      duration: "1h30",
  ...
  const topSalons = [
    ...
    },
    {
      ...
      rating: 4.7,
      reviews: 156,
      nextSlot: "Demain 11h30",
      speciality: "Manucure & Pédicure"
    }
  ];

  const handleSearch = () => {
    setLocation(`/search?q=manucure&location=${encodeURIComponent(searchLocation || 'paris')}`);
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-gray-900">Services Manucure</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/30 backdrop-blur-md border-white/40 border rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-black">Services Manucure</span>
          </div>
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Trouvez les meilleurs salons d'onglerie et instituts de manucure près de chez vous
          </p>
          ...
          <div className="max-w-md mx-auto mb-8">
            <div className="space-y-3">
              ...
              >
                ...
                Rechercher des salons d'onglerie
              </Button>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="text-center mt-8">
            <Button 
              ...
              onClick={handleSearch}
            >
              Voir tous les salons d'onglerie
            </Button>
          </div>
        </motion.section>
