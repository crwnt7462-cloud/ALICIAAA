     ...
     {[
      ...
      <button
       ...
       className={`flex-1 flex items-center justify-center gap-2 py-4 px-4 text-sm font-medium transition-colors ${
        activeTab === tab.id
         ? 'bg-blue-500/20 backdrop-blur-sm border border-blue-300/30 text-blue-700 hover:bg-blue-500/30-pink border-b-2 border-violet-600'
           ...
           {category.services.map(service => (
            <div key={service.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
             ...
             <div className="text-right ml-4">
              ...
              <Button 
               size="sm" 
               className="mt-2 bg-blue-500/20 backdrop-blur-sm border border-blue-300/30 text-blue-700 hover:bg-blue-500/30-pink"
