...
interface ServiceCategory {
  ...
  services: Service[];
  description?: string;
  richDescription?: string; // HTML avec formatage
}
...
export default function BarbierGentlemanMarais() {
  ...
  const [serviceCategories, setServiceCategories] = useState<ServiceCategory[]>([
    ...
    },
    {
      ...
      name: 'Soins Homme',
      expanded: false,
      description: 'Découvrez nos <strong>soins visage masculins</strong> spécialement conçus pour la peau des hommes. Des protocoles <em>personnalisés</em> utilisant des produits <u>professionnels</u> pour purifier, hydrater et revitaliser votre peau. Nos experts vous accompagnent pour une routine de soin <strong>adaptée</strong> à votre type de peau.',
      services: [
        { 
          id: 9, 
  ...
  const [teamMembers] = useState<TeamMember[]>([
    {
      ...
      specialties: ["Coupe traditionnelle", "Rasage au coupe-chou", "Conseil style"],
      rating: 4.9,
      reviewsCount: 156,
      bio: "15 ans d'expérience dans l'art du barbier traditionnel. Formé aux techniques ancestrales, Antoine perpétue l'excellence du savoir-faire français."
    },
    {
      id: 2,
      name: "Julien Moreau",
      ...
      specialties: ["Coupe moderne", "Dégradés", "Barbe styling"],
      rating: 4.8,
      reviewsCount: 89,
      bio: "Spécialiste des coupes modernes et des dégradés précis. Julien associe créativité contemporaine et techniques classiques."
    },
    {
      id: 3,
      name: "Pierre Dubois",
      role: "Coiffeur Senior",
      specialties: ["Coupes classiques", "Soins capillaires", "Conseil"],
      rating: 4.7,
      reviewsCount: 67,
      bio: "Expert en coupes classiques et soins capillaires masculins. Pierre vous guide dans le choix de la coupe idéale."
    }
  ]);
