  ...
  const features = [
    {
      ...
      color: "bg-violet-500/30 backdrop-blur-md border border-violet-300/20 shadow-lg shadow-violet-500/20/40 backdrop-blur-sm border border-violet-300/30"
    },
    {
      icon: Users,
      title: "Clients",
      ...
      <div className="relative">
        ...
        <div className="px-6 pt-16 pb-6">
          <div className="max-w-sm mx-auto">
            ...
            {/* Badge Premium */}
            <div className="bg-violet-500/30 backdrop-blur-md border border-violet-300/20 shadow-lg shadow-violet-500/20/30 backdrop-blur-md border border-violet-300/20 shadow-lg shadow-violet-500/20 rounded-2xl p-4 mb-8 text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
                <Crown className="h-5 w-5 text-violet-700" />
                <span className="text-violet-700 font-semibold">Premium Active</span>
              </div>
              <p className="text-violet-600 text-sm opacity-90">Accès complet aux outils pro</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {features.map((feature, index) => (
                <button
                  ...
                  className="bg-gray-50 hover:bg-violet-500/30 backdrop-blur-md border border-violet-300/20 shadow-lg shadow-violet-500/20 rounded-2xl p-4 transition-colors text-left"
                >
            ...
            <div className="space-y-3">
              <button
                ...
                className={`w-full h-12 ${getGenericGlassButton(0)} text-black rounded-2xl text-base font-medium transition-colors`}
              >
                Nouveau rendez-vous
              </button>
              ...
              <button
                ...
                className="w-full h-12 bg-gray-50 hover:bg-violet-500/30 backdrop-blur-md border border-violet-300/20 shadow-lg shadow-violet-500/20 text-gray-700 rounded-2xl text-base font-medium transition-colors"
              >
                Ouvrir messagerie
              </button>
            </div>
