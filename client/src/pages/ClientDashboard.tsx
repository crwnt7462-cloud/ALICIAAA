          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                {/* ✅ GLASSMORPHISM APPLIQUÉ - Stats Fidélité Client */}
                <div className="grid grid-cols-3 gap-2 mb-4">
                  <div className="text-center p-3 glass-stat-card rounded-xl">
                    <div className="text-lg font-bold text-amber-600 mb-1">12</div>
                    <div className="text-xs text-gray-700">RDV ce mois</div>
                  </div>
                  <div className="text-center p-3 glass-stat-card rounded-xl">
                    <div className="text-lg font-bold text-amber-600 mb-1">4.8</div>
                    <div className="text-xs text-gray-700">Note moyenne</div>
                  </div>
                  <div className="text-center p-3 glass-stat-card rounded-xl">
                    <div className="text-lg font-bold text-amber-600 mb-1">15%</div>
                    <div className="text-xs text-gray-700">Réduction</div>
                  </div>
                </div>
