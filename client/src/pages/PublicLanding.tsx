      ...
      >
       ...
       <div className="p-4">
        ...
        <div className="flex items-center justify-between">
         ...
         <button 
          className={`${getGenericGlassButton(1)} text-black px-4 py-2 rounded-xl text-sm font-medium`}
          onClick={(e) => {
           e.stopPropagation();
      ...
      >
       ...
       <div className="p-4">
        ...
        <div className="flex items-center justify-between">
         ...
         <button 
          className={`${getGenericGlassButton(2)} text-black px-4 py-2 rounded-xl text-sm font-medium`}
          onClick={(e) => {
           e.stopPropagation();
           setLocation('/salon-booking');
          }}
      ...
      >
       ...
       <div className="p-4">
        ...
        <div className="flex items-center justify-between">
         ...
         <button 
          className={`${getGenericGlassButton(3)} text-black px-4 py-2 rounded-xl text-sm font-medium`}
          onClick={(e) => {
           e.stopPropagation();
           setLocation('/salon-booking');
          }}
      ...
      >
       ...
       <div className="p-4">
        ...
        <div className="flex items-center justify-between">
         ...
         <button 
          className={`${getGenericGlassButton(4)} text-black px-4 py-2 rounded-xl text-sm font-medium`}
          onClick={(e) => {
           e.stopPropagation();
           setLocation('/salon-booking');
          }}
