   ...
   <div className="max-w-lg mx-auto bg-white shadow-xl">
            ...
            {category.services.map((service, serviceIndex) => (
             <div key={service.id} className={`p-4 flex items-center justify-between ${serviceIndex !== category.services.length - 1 ? 'border-b border-gray-100' : ''}`}>
              ...
              <Button 
               ...
               className="className={`${getGenericGlassButton(1)} text-black hover:bg-violet-700 h-8 px-4 text-xs font-medium transition-all duration-300"
              >
               Choisir
              </Button>
             </div>
    ...
    <div className="bg-white border-t border-gray-100 p-3">
     <Button 
      ...
      className="w-full className={`${getGenericGlassButton(1)} text-black hover:bg-violet-700 h-11 text-sm font-medium transition-all duration-300 hover:scale-[1.01] transform active:scale-95"
     >
      Réserver maintenant
     </Button>
    </div>
