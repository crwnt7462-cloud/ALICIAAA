...
export default function SearchResults() {
  ...
  return (
    <div className="heroSlash">
      ...
      <footer className="bg-gradient-to-br from-gray-900/95 via-gray-800/90 to-gray-900/95 backdrop-blur-xl border-t border-white/10 py-8 w-full">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            
            {/* Logo et description */}
            <div className="lg:flex-1">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-violet-400 to-amber-400 bg-clip-text text-transparent mb-2">
                Avyento
              </h3>
              <p className="text-gray-300 text-sm max-w-xs">
                La plateforme IA qui révolutionne la beauté
              </p>
            </div>

            {/* Navigation en ligne horizontale */}
            <div className="flex flex-wrap gap-6 lg:gap-10 text-sm">
              <div className="flex flex-col gap-1">
                <h4 className="font-semibold text-white mb-1">Services</h4>
                <div className="flex gap-3 text-gray-300">
                  <span onClick={() => setLocation('/search')} className="cursor-pointer hover:text-violet-400 transition-colors">
                    Coiffure
                  </span>
                  <span onClick={() => setLocation('/search')} className="cursor-pointer hover:text-violet-400 transition-colors">
                    Esthétique
              ...
              <div className="flex flex-col gap-1">
                <h4 className="font-semibold text-white mb-1">Partenaires</h4>
                <div className="flex gap-3 text-gray-300">
                  <span onClick={() => setLocation('/devenir-partenaire')} className="cursor-pointer hover:text-violet-400 transition-colors">
                    Devenir partenaire
                  </span>
                  <span onClick={() => setLocation('/formation')} className="cursor-pointer hover:text-violet-400 transition-colors">
                    Formation
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex gap-3 text-gray-300">
                  <span onClick={() => setLocation('/centre-aide')} className="cursor-pointer hover:text-violet-400 transition-colors">
                    Centre d'aide
                  </span>
                  <span onClick={() => setLocation('/contact')} className="cursor-pointer hover:text-violet-400 transition-colors">
                    Contact
                  </span>
                </div>
              </div>
            ...
            <div className="flex flex-col items-start lg:items-end gap-3 lg:flex-1 lg:text-right">
              <div className="flex gap-2">
                <a href="https://twitter.com/avyento" target="_blank" rel="noopener noreferrer" 
                   className="p-2 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 transition-all duration-300">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M6.29 18.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0020 3.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 7.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 010 16.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </a>
                <a href="https://instagram.com/useavyento" target="_blank" rel="noopener noreferrer" 
                   className="p-2 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 transition-all duration-300">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="https://tiktok.com/@avyento" target="_blank" rel="noopener noreferrer" 
                   className="p-2 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 transition-all duration-300">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
