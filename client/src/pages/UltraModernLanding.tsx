    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div className="flex justify-between items-center h-16">
      <div className="flex items-center">
       ...
       <Badge className="ml-3 className={`${getGenericGlassButton(0)} text-black text-xs">
        Premium
       </Badge>
      </div>
      ...
      <nav className="hidden md:flex items-center space-x-8">
       ...
       <Button 
        className="className={`${getGenericGlassButton(0)} text-black"
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
     <div className="text-center mb-12">
        ...
        <div className="flex items-center space-x-4">
         ...
         <div className="flex items-center space-x-2 pr-2">
          ...
          <Button 
           ...
           className="className={`${getGenericGlassButton(0)} text-black px-8 py-3 rounded-xl"
          >
           Rechercher
          </Button>
         </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
       <Button 
        size="lg"
        className="className={`${getGenericGlassButton(0)} text-black px-8 py-4 rounded-xl text-lg"
        ...
        <CardContent className="p-6">
         ...
         <div className="flex flex-wrap gap-2 mb-4">
          {salon.badges.map((badge, idx) => (
           <Badge key={idx} className="className={`${getGenericGlassButton(0)} text-black text-xs">
         ...
         <Button 
          className="w-full className={`${getGenericGlassButton(0)} text-black"
          onClick={(e) => {
           e.stopPropagation();
           setLocation("/booking");
          }}
