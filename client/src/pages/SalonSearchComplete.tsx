        ...
        <div className="relative h-48 bg-gradient-to-br from-violet-400 to-purple-500">
         ...
         {salon.promotion && (
          <div className="absolute bottom-3 left-3">
           <span className="className={`${getGenericGlassButton(2)} text-black text-xs px-2 py-1 rounded-full font-medium">
            {salon.promotion}
           </span>
          </div>
         )}
        ...
        <div className="p-4">
         ...
         <div className="flex items-center justify-between">
          ...
          <motion.button 
           whileHover={{ scale: 1.05 }}
           whileTap={{ scale: 0.95 }}
           className={`${getGenericGlassButton(0)} text-black px-4 py-2 rounded-xl text-sm font-medium`}
           onClick={(e) => {
            e.stopPropagation();
