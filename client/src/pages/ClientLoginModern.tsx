        ...
        <div className="px-6 pt-16 pb-6">
          <div className="max-w-sm mx-auto glass-card p-8 rounded-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 mb-6">
              ...
              {/* Bouton connexion - style glassmorphism Apple violet */}
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full h-12 backdrop-blur-md bg-violet-500/20 border border-violet-400/30 rounded-2xl text-base font-medium text-violet-900 
                  hover:bg-violet-500/30 hover:border-violet-400/40 hover:shadow-lg hover:shadow-violet-500/20
